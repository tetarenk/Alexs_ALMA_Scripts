...
i='SiO'
make_TMAX(datadir+'alex_imaging_'+i+'_fix2/GRS1915_modelimg_'+i+'.image.pbcor.fits',datadir,i)


#convert vla image so only 2 dimensional for contours
...
im=plt.imshow(np.nan_to_num(data1),origin="lower",cmap=cm.get_cmap('hot_r', 500),norm=colors.PowerNorm(gamma=1),vmin=0.,vmax=0.25)#,vmax=1.2)#65,55,65,0.9,0.9,0.9,0.9/x,x,x,0.1,0.045,0.065
